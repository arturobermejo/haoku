...
export function PdfColumn({ doc, scale, scrollRootRef, onCurrentPageChange }: PdfColumnProps) {
  ...
  return (
    <div ref={columnRef} className="pdf-column">
        ...
        return (
          <Fragment key={pageNumber}>
            ...
            <div className="sheet-slot" data-page-number={pageNumber}>
              <PdfPage proxy={doc.proxy} pageNumber={pageNumber} dims={dims} scale={scale} shouldRender={nearPages.has(pageNumber)} />
            </div>
          </Fragment>
        )
      })}
