...
const VIEW_ACTIONS = new Set<Action['type']>(['load', 'answerQuiz', 'reveal', 'select', 'startCollecting', 'stopCollecting', 'collect', 'uncollect', 'focus', 'openViewer', 'closeViewer', 'undo', 'redo'])
